export const COMPANY = {
  ...
  emailSales: "sales@bethstreamsolutions.com",
...
export const PRODUCT_CATEGORIES = [
  ...
  },
  {
    ...
    icon: "accessories",
    color: "sky",
    subcategories: ["Cables & Connectors", "Power Supplies", "Mounting Brackets", "PoE Injectors", "Surge Protectors", "Cable Management"],
    description: "Essential accessories and components to complete your security and networking setup.",
